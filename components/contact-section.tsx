  ...
  return (
    <section id="contact" className="py-20 bg-gray-800/30">
      <div className="container mx-auto px-4">
        ...
        >
          Get In{" "}
          <span className="bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent">Touch</span>
        </motion.h2>
          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">+91 7060714014</p>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://instagram.com/harrsh_it"
                ...
                <a
                  href="https://github.com/harrsh-it"
                  className="bg-gray-700 hover:bg-gray-600 w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300"
                >
                  <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
